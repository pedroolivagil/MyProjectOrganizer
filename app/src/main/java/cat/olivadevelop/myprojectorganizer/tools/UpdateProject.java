 ...
 */
public class UpdateProject extends AsyncTask<Void, Void, RequestBody> {
    // claves fichero json
    ...
    public UpdateProject(Activity activity, String pjtName, HashMap<String, String> values, String projectHeaderImag,
